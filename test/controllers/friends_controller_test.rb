...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { description: @friend.description, name: @friend.name, picture: @friend.picture } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { description: @friend.description, name: @friend.name, picture: @friend.picture } }
